...
from app.pipeline.validators.technical_rules import TechnicalRulesEngine
from app.pipeline.validators.medical_rules import MedicalRulesEngine
...
class StaticValidationStage(BaseStage):
    ...
    async def execute(self, claims: List[Dict]) -> List[Dict]:
        ...
        for claim in claims:
            ...
            technical_errors = self.technical_engine.validate(claim)
